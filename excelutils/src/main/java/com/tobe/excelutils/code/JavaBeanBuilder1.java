...
/**
 * 根据字段类表构建一个javaBean,复杂的考虑使用FreeMarker
 *
 */
public class JavaBeanBuilder1 implements ICodeBuilder {
	...
	public JavaBeanBuilder1(String packageName, String className){
	...
	public static void main(String[] args) {
		JavaBeanBuilder1 bb = new JavaBeanBuilder1("com.game.bean", "hello");
		bb.getFields().add("age");
		bb.getFields().add("sex");
